...
/**
 * This is the item provider adapter for a {@link arduino.App} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AppItemProvider extends NameElementItemProvider {
	/**
	...
	protected void addInitialPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						ArduinoPackage.Literals.APP__INITIAL, true, false, true, null, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ArduinoPackage.Literals.APP__STATES);
			childrenFeatures.add(ArduinoPackage.Literals.APP__BRICKS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors
				.add(createChildParameter(ArduinoPackage.Literals.APP__STATES, ArduinoFactory.eINSTANCE.createState()));

		newChildDescriptors
				.add(createChildParameter(ArduinoPackage.Literals.APP__BRICKS, ArduinoFactory.eINSTANCE.createBrick()));

		newChildDescriptors.add(
				createChildParameter(ArduinoPackage.Literals.APP__BRICKS, ArduinoFactory.eINSTANCE.createSensor()));

		newChildDescriptors.add(
				createChildParameter(ArduinoPackage.Literals.APP__BRICKS, ArduinoFactory.eINSTANCE.createActuator()));
	}
