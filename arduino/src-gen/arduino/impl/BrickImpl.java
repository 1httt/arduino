 ...
 * </p>
 * <ul>
 *   <li>{@link arduino.impl.BrickImpl#getPin <em>Pin</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BrickImpl extends NameElementImpl implements Brick {
	/**
	...
	protected EClass eStaticClass() {
		return ArduinoPackage.Literals.BRICK;
	}
	...
	public void setPin(int newPin) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ArduinoPackage.BRICK__PIN, oldPin, pin));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case ArduinoPackage.BRICK__PIN:
			return getPin();
		}
