...
public class ArduinoSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
		case ArduinoPackage.NAME_ELEMENT: {
		...
		case ArduinoPackage.APP: {
			App app = (App) theEObject;
			T result = caseApp(app);
			if (result == null)
				result = caseNameElement(app);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case ArduinoPackage.STATE: {
			...
			if (result == null)
				result = caseNameElement(state);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case ArduinoPackage.BRICK: {
			Brick brick = (Brick) theEObject;
			T result = caseBrick(brick);
			if (result == null)
				result = caseNameElement(brick);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case ArduinoPackage.ACTUATOR: {
			...
			if (result == null)
				result = caseNameElement(actuator);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
